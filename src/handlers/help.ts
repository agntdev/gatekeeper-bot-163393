...
const HELP =
  "Use /start to open the moderation dashboard.\n\n" +
  "Admins can also reply to a member with /warn, /trust, or /untrust.\n" +
  "Use /setwelcome, /setrules, and /stats to manage this group.";
